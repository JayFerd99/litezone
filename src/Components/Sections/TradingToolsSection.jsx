...
import tradingTools from "../../images/illustrations/Bitcoin.png";
import PrimaryButton from "../buttons/PrimaryButton";

export default function TradingToolsSection() {
  return (
    <section className="px-4">
      <div className="rounded-3xl bg-gradient-to-b from-[#FFFFFF] to-[#F4F9FF] py-10">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="lg:row-start-1 max-w-lg">
              <h2 className="font-bold text-4xl mb-6 leading-normal">
                Advanced Trading{" "}
                <span className="text-red-gradient">Tools</span>
              </h2>
              <div className="mb-6">
              ...
              <PrimaryButton className="h-10 text-center">
                Get Started
              </PrimaryButton>
              <a href="#">
                <button className="py-4 px-10 text-mood underline">
                  Learn more
                </button>
              </a>
            </div>
