...
export default function Select({ onChange, value = "BTC" }) {
  const data = [
    {
      name: "NGN",
      code: "NGN",
      icon: "/cryptocurrencies/nigeria.svg",
    },
    {
      name: "USD",
      code: "USD",
    ...
    },
    {
      name: "DON",
      code: "DON",
      icon: "/cryptocurrencies/dontoken.png",
    },
  ];
  ...
  return (
    <div className="relative">
      ...
      <div
        className="border border-mood cursor-pointer rounded-2xl py-3 md:py-4 px-4 md:px-6 flex items-center"
      ...
      <div
        className={classNames(
          "absolute top-full right-0 left-0 bg-white z-[2] mt-4 rounded-xl shadow-xl border border-mood overflow-hidden",
          {
        ...
        <div>
          {data.map((coin, i) => (
            <div
              key={i}
              className={classNames(
                "py-2 flex items-center cursor-pointer hover:text-white select-none px-4 hover:bg-mood",
                {
